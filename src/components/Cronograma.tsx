...
const inicial: Semana = {
  dias: [
    ...
    { dia: "Viernes 24",   temas: ["Resolución de Problemas"],                             profesor: "Ignacio Muñoz", nota: "Charla sponsor TopSort durante clases. Actividades hasta las 16:30.", material: [{ name: "Slides", path: "/material/inicial/2026-07-24/slides.pdf" }] },
