...
const inicial: Semana = {
  dias: [
    ...
    { dia: "Viernes 31",   temas: ["Cierre"],                                              profesor: "Benjamín Letelier", nota: "Actividades hasta las 13:30", material: [{ name: "Slides", path: "/material/inicial/2025-07-30/slides.pdf" }]  },
  ],
};
